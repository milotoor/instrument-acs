      ...
      <div className="max-w-[800px]">
        ...
        <NoteCard>
          <FAQ question="What is this?">
            ...
            colloquially called the "instrument check ride", is an oral and practical exam in which
            I will demonstrate to an FAA-certified <Term>designated pilot examiner (DPE)</Term> that
            I am sufficiently knowledgeable about and capable of instrument flying. This exam is
            graded according to rubric known as the{' '}
          ...
          <FAQ question="What is the ACS?">
            ...
            take their check ride (see link above). It is an official document published by the FAA
            which prescribes what knowledge and skills applicants must demonstrate in order to pass
            the test. In the instrument ACS there are 8 sections (known as "Areas of Operation"),
            each with between 1 and 5 subtasks. This website is oriented around these sections and
            subtasks; they can be accessed using the table of contents in the main menu.
          </FAQ>
          ...
          <FAQ question="Who is this for?">
            ...
            <div className="pt-3">
              These notes are also for other students to use and learn from, should they so desire.
              However, anyone who uses this site should understand that{' '}
              <Warning>I am not a CFII nor an instrument ground instructor!</Warning> The
              information presented on this website has been procured from various sources, many of
              which are explicitly cited where appropriate. HOWEVER, my own opinions and preferences
              are also presented here, and it is left to the reader to determine which information
              is fact or fiction. <Success>Use the cited sources</Success> and{' '}
          ...
          <FAQ question="But ____ is clearly wrong...">
            ...
            and ACS are evolving documents. It's unclear to me at this time how much effort it will
            be to maintain this resource into the future: how often will the FAR/AIM change
            substantively? How often do sections/paragraphs get renumbered? The answers to these
            will have a profound impact on the maintainability of the website, and I just don't know
            yet.
            <div className="pt-3">
              ...
              <BulletList type="decimal">
                <>
                  ...
                  <Link href={references.github.pull_requests}>pull request</Link>) on GitHub. This
                  will require you to have a GitHub account.
                </>
                <>
