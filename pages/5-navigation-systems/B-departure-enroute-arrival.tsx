                ...
                <Tabs>
                  <Tab heading="ODPs">
                    <Paragraph>
                      ...
                      The procedures are provided alongside the takeoff minima on both the FAA
                      charts and Jeppesen 10-9 pages.
                    </Paragraph>
                    <Paragraph>
                      <Image src="departure_procedure" />
                    </Paragraph>
                    <Paragraph>
                      An ODP must be developed when obstructions penetrate the 40:1 departure
                      obstacle clearance surface (OCS) as described in{' '}
                  ...
                  <Tab heading="DVAs & VCOA">
                    ...
                    <Paragraph>
                      <Image src="departure_procedure">
                        In the procedure above, the VCOA has a minimum ceiling of 4400' and
                        visibility of 3 statute miles. Pilots flying the VCOA procedure are{' '}
                        <Bold>
                          expected to remain within 3 statute miles of the airport until reaching
                          the "at or above" altitude (in this case 9400')
                        </Bold>
