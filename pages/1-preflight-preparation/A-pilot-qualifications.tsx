      ...
      notes={{
        ...
        k1: [
          <>
            ...
            <FAR section="61.57" paragraph={['c', 1]} />. These include recording in the last 6
            months:{' '}
            <InlineList>
          ...
          <>
            ...
            See <FAR section="61.51" paragraph="g" />. The FAA's{' '}
            <Link.Reference reference="InFO 15012" /> specifies an approach can only be logged if{' '}
          ...
          <>
            ...
            <Bold>instrument proficiency check</Bold> (see <FAR section="61.57" paragraph="d" />
        ...
        k2: [
          <>
            <Quotation source={<FAR section="61.3" paragraph="e" />}>
          ...
          <>
            ...
            . See <FAR section="91.109" paragraph={['c', 1]} /> and{' '}
            <FAR section="61.3" paragraph={['c', 1]} />.
          </>,
        ],
        ...
        k3: [
          <ReferenceList
            references={[
              <FAR section="61.113" paragraph="i" />,
              <FAR section="61.23" paragraph={['c', 3]} />,
            ]}
          />,
          <>
            Per <FAR section="61.113" paragraph="i" />, a private pilot with a U.S. driver's license
          ...
          <>
            ...
            <FAR section="68.3" />) in their logbook. To act as PIC on an IFR flight plan they must
            have an instrument rating and be current.
          </>,
        ],
